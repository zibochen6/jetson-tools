...
function Fingerprint({
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-left dark:border-slate-700/70 dark:bg-slate-900/50">
      <div className="text-xs text-slate-500 dark:text-slate-400">{label}</div>
      <code
        className="mt-0.5 block break-all font-mono text-xs text-slate-800 dark:text-sky-300/90"
      >
        {fingerprint}
      </code>
    </div>
